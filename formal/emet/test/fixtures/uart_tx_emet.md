<!-- Fixture: spec/uart_tx.md as PR #21 (spec/20-uart-tx-emet) converts it, once
     PR #18 (spec/emet.md) and #21 land. Copied verbatim so the compiler has a
     real target to compile against without depending on either PR merging;
     resync this file if either PR changes before merge. -->
